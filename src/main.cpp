...
void clear() {
    ...
    Color topColor = {24, 27, 34, 255};  // color of the top wall
    Color bottomColor = {24, 27, 34, 255};  // Midnight blue
...
void displayWelcomeMessage() {
    ...
    SDL_Surface* surfaceMessage = TTF_RenderText_Solid(font, "Welcome The Last of Us, find the window and press right click to escape", textColor);
...
void displayWinningMessage() {
    ...
    SDL_Color textColor = { 255, 255, 255, 255 };
    SDL_Surface* surfaceMessage = TTF_RenderText_Solid(font, "You escaped!", textColor);
    SDL_Texture* welcomeMessage = SDL_CreateTextureFromSurface(renderer, surfaceMessage);
...
void displayLosingMessage() {
    ...
    SDL_Color textColor = { 255, 255, 255, 255 };
    SDL_Surface* surfaceMessage = TTF_RenderText_Solid(font, "Error, please try again", textColor);
    SDL_Texture* welcomeMessage = SDL_CreateTextureFromSurface(renderer, surfaceMessage);
...
int main() {
    ...
    // Load the music file
    Mix_Music* music = Mix_LoadMUS("./assets/tlouMusic.mp3");
    if (!music) {
        std::cout << "Mix_LoadMUS error: " << Mix_GetError() << std::endl;
    }

    // Load the sound effect file
    Mix_Chunk* soundEffect = Mix_LoadWAV("./assets/tlouStep.mp3");
    if (!soundEffect) {
    ...
    // Load the images
    ImageLoader::init();
    ImageLoader::loadImage("+", "assets/wall3.jpeg");
    ImageLoader::loadImage("-", "assets/wall1.jpeg");
    ImageLoader::loadImage("|", "assets/wall2.jpeg");
    ImageLoader::loadImage("*", "assets/wall4.jpeg");
    ImageLoader::loadImage("g", "assets/window.jpg");
    ImageLoader::loadImage("p", "assets/tlouUI.png");
    ImageLoader::loadImage("pg", "assets/tlouUI2.png");
